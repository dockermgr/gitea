...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410251208-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Oct 25, 2024 12:08 EDT
# @@File             :  install.sh
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export APPNAME="gitea"
export VERSION="202410251208-git"
...
DOCKER_REGISTRY_REPO_NAME="gitea"
...
CONTAINER_WEB_SERVER_VHOSTS="$CONTAINER_DOMAINNAME,$CONTAINER_HOSTNAME.all"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
