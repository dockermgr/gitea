...
# Defaults
APPNAME="gitea"
APPDIR="$HOME/.local/share/docker/gitea"
DATADIR="$HOME/.local/share/docker/gitea/files"
INSTDIR="$HOME/.local/share/dockermgr/docker/gitea"
...
SERVER_PORT_SSL="${SERVER_PORT_SSL:-3000}"
SERVER_PORT_SSL_INT="${SERVER_PORT_SSL_INT:-3000}"
