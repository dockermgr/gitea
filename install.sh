...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210081555-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Oct 08, 2022 16:33 EDT
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/gitea"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="gitea"
INSTDIR="$HOME/.local/share/dockermgr/gitea"
APPDIR="$HOME/.local/share/srv/docker/gitea"
DATADIR="$HOME/.local/share/srv/docker/gitea/files"
...
SERVER_PORT_EXT="${SERVER_PORT_EXT:-3030}"
SERVER_PORT_INT="${SERVER_PORT_INT:-3000}"
SERVER_PORT_ADMIN_EXT="${SERVER_PORT_ADMIN_EXT:-}"
SERVER_PORT_ADMIN_INT="${SERVER_PORT_ADMIN_INT:-}"
SERVER_PORT_OTHER_EXT="${SERVER_PORT_OTHER_EXT:-7822}"
SERVER_PORT_OTHER_INT="${SERVER_PORT_OTHER_INT:-22}"
...
HUB_URL="casjaysdevdocker/gitea"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
