...
# @File          : gitea
# @Description   : A community managed painless self-hosted Git service
# @TODO          :
# @Other         :
# @Resource      :
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SERVER_PORT_ADMIN_INT="${SERVER_PORT_SSL_INT:-16000}"
SERVER_PORT_OTHER="${SERVER_PORT_SSL:-7822}"
SERVER_PORT_OTHER_INT="${SERVER_PORT_SSL_INT:-7822}"
